...
@section('title', 'Tambah Produk Baru - Toko Bunga')
                    ...
                    <div class="mb-8">
                        ...
                        <div class="flex items-center space-x-6">
                            <label class="flex items-center">
                                <input type="checkbox" name="is_active" class="text-black focus:ring-black" checked>
                                <span class="ml-2 text-sm text-gray-700">Tampilkan produk</span>
                            </label>
                            <label class="flex items-center">
                                <input type="checkbox" name="is_featured" class="text-black focus:ring-black">
